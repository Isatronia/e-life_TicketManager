<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="companyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="成立时间" align="center" prop="foundTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.foundTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="营业执照" align="center" prop="certificate" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.certificate" :width="50" :height="50"/>
        </template>
      </el-table-column>
      <el-table-column label="其他材料" align="center" prop="additionalInfo" />
      <el-table-column label="申请提交时间" align="center" prop="applyDate" width="180">
        <template slot-scope="scope">
...
<script>
import { listCompany, getCompany, delCompany, addCompany, updateCompany } from "@/api/feature/company";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('feature/company/export', {
        ...this.queryParams
