    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['feature:subscribe:add']"
          >新增</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['feature:subscribe:remove']"
          >删除</el-button
        >
      </el-col>
      <right-toolbar
...
export default {
  ...
  methods: {
    ...
    //   getSubscribe(userId).then(response => {
    ...
    /** 导出按钮操作 */
    // handleExport() {
    //   this.download('feature/subscribe/export', {
    //     ...this.queryParams
